...
public class Vitamin {
    ...
    public Vitamin(String bez, int alterMin, int alterMax, double einheitProTag, String einheit, String geschlecht) {
        this.bez = bez;
    ...
    public String toString() {
        return "Vitamin{" + "bez=" + bez + ", alterMin=" + alterMin + ", alterMax=" + alterMax + ", einheitProTag=" + einheitProTag + ", einheit=" + einheit + ", geschlecht=" + geschlecht + '}';
    }
